  ...
  async up (queryInterface, Sequelize) {
    ...
    */
    ...
    await queryInterface.bulkInsert('Order_Products', [
      { order_id: 1, product_id: 1, quantity: 1, serve_state: 'pending', createdAt: new Date(), updatedAt: new Date() },
      { order_id: 1, product_id: 3, quantity: 1, serve_state: 'pending', createdAt: new Date(), updatedAt: new Date() },
      { order_id: 2, product_id: 2, quantity: 1, serve_state: 'pending', createdAt: new Date(), updatedAt: new Date() },
      { order_id: 2, product_id: 4, quantity: 1, serve_state: 'pending', createdAt: new Date(), updatedAt: new Date() }
    ])
